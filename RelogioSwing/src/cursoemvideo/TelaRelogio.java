...
public class TelaRelogio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnHora.setText("Obter informações");
        ...
        lblIdioma.setForeground(new java.awt.Color(0, 102, 0));
        lblIdioma.setText(" ");

        lblResolucao.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lblResolucao.setForeground(new java.awt.Color(255, 153, 153));
    ...
    private void btnHoraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHoraActionPerformed
        ...
        lblHora.setText(hoje.toString());
        // obtem o idioma do sistema
        lblIdioma.setText(local.getDisplayLanguage() + "-" + local.getDisplayName() + "  " + local.getDisplayCountry());
        
        // obtem a resolução do monitor
        lblResolucao.setText(tela.getWidth() + " x " + tela.getHeight());
